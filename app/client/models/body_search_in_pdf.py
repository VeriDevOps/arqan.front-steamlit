...
T = TypeVar("T", bound="BodySearchInPdf")


@_attrs_define
class BodySearchInPdf:
    """
    Attributes:
    ...
    sec_req_search: "SearchInPDFRequest"
    file: File
    ...
    def to_multipart(self) -> Dict[str, Any]:
        sec_req_search = (
            None,
            json.dumps(self.sec_req_search.to_dict()).encode(),
            "application/json",
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        sec_req_search = SearchInPDFRequest.from_dict(d.pop("sec_req_search"))
        ...
        body_post_sec_req_search_in_pdf_api_tasks_sec_req_search_in_pdf_post.additional_properties = (
            d
        )
